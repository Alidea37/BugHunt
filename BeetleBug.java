...
class BeetleBug extends Bug {
    public BeetleBug(JFrame myJFrame, int hitsNeeded, int directionChangeProbability){
        super(myJFrame, hitsNeeded, directionChangeProbability);//call Bug constructor
        // set up images for slow bug
        bugImageName[UP]="BeetleUp.jpg";
        bugImageName[DOWN]="BeetleDown.jpg";
        bugImageName[LEFT]="BeetleLeft.jpg";
        bugImageName[RIGHT]="BeetleRight.jpg";
